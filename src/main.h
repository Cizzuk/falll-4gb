...
#define DOG_COLLISION_MARGIN_LEFT (DOG_VISUAL_MARGIN_LEFT + 1U)
...
#define PLAY_COLUMN_EXTRA_DOG 2U
...
#define LEAF1_START_X (PLAY_AREA_MIN_X + 8U)
#define LEAF1_START_Y 0U
#define LEAF2_START_X ((PLAY_AREA_MIN_X + PLAY_AREA_MAX_X) / 2U)
#define LEAF2_START_Y 0U
#define LEAF3_START_X (PLAY_AREA_MAX_X - 8U)
#define LEAF3_START_Y 0U

#define FALL_ITEM_RANDOM_MIN_X PLAY_AREA_MIN_X + 4U
#define FALL_ITEM_RANDOM_MAX_X PLAY_AREA_MAX_X - 4U
...
#define APPLE_MARGIN_TOP 3U
#define APPLE_MARGIN_LEFT 2U
#define APPLE_MARGIN_RIGHT 4U
#define APPLE_MARGIN_BOTTOM 1U
#define BOMB_MARGIN_TOP 6U
#define BOMB_MARGIN_LEFT 4U
#define BOMB_MARGIN_RIGHT 6U
#define BOMB_MARGIN_BOTTOM 2U
...
void set_map_base(void);
void set_map_tree(void);
void set_map_tree_curtain(void);
void init_game(void);
